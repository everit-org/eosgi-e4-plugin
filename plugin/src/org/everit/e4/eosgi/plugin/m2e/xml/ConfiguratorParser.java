...
public class ConfiguratorParser {
    ...
    private void processEnvironments(Xpp3Dom children) {
    ...
    private BundleSettings processBundleSettings(Xpp3Dom children) {
    ...
    private Bundle processBundle(Xpp3Dom bundlesDom) {
    ...
    private List<String> processVmOptions(Xpp3Dom children) {
